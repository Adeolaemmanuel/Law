...
export class Vacancy extends Component<PostVacancyProps, PostVacancyState> {
    constructor(props: any) {
        super(props);
        this.state = {
            vacancy: { title: null, company: null, type: 'Full Time', location: null, experience: null, user: null, job: 'Vacancy', summary: null, id: 0},
        };
    }
                    ...
                    <View style={Styles.container} >
                        <View style={Styles.containerPaddingMargin}>
                            ...
                            <View style={Styles.containerRow} >
                                ...
                                />
                                <Picker
                                    selectedValue={this.state.vacancy.type}
                                    mode="dropdown"
                                    onValueChange={(text) =>{
                                        let vacancy = {...this.state.vacancy};
                                        vacancy.type = text;
                                    ...
                                    <Picker.Item label="Per-Time" value="Per-Time" />
                                </Picker>
                            </View>
                            <View style={Styles.containerRow} >
                                <TextInput
