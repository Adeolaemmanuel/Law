...
import { Signup, DashUser, UserProfile, UserEdit } from '../Users';
    ...
    render(){
        return (
            <Stack.Navigator>
                ...
                <Stack.Screen 
                name="User Dash" 
                options={{ headerTitleAlign: 'center', headerTitle: 'Dashboard', headerLeft: ()=> false }} 
                component={DashUser} 
                />
                <Stack.Screen 
                name="Settings" 
                ...
                <Stack.Screen 
                name="Message" 
                options={{ headerTitleAlign: 'center', headerTitle: 'Message' }} 
                component={Message} 
                />
                <Stack.Screen 
                name="User Profile" 
